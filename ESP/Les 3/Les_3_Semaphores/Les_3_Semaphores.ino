...
// milliseconds, will quickly become a bigger number than can be stored in an int. //https://esp32io.com/tutorials/esp32-button-debounce
...
printf("The button %d is pressed\r\n", button_gpio); if (button_gpio==26)
          blink_sem_led(200);
else
          blink_sem_led(400);
      }
else if(lastSteadyState == LOW && currentState == HIGH){ printf("The button %d is released\r\n", button_gpio);
      }
...
// function blinks GPIO_led_sem in given rate(ms) for 10 times void blink_sem_led(int rate){
